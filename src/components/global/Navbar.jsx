...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={`${styles.paddingX} fixed top-0 z-20 flex w-full items-center py-5 ${scrolled ? "bg-background/75 backdrop-blur-sm" : "bg-transparent"} transition-colors duration-500`}>
